...
export function ClockIcon(props) {
  return (
    <svg
      ...
      height="16"
      fill="currentColor"
      className={`bi bi-clock ${props.className ? props.className : ''}`}
      viewBox="0 0 16 16"
      alt="Clock Icon"
    >
...
export function TrashIcon(props) {
  return (
    <svg
      ...
      height="16"
      fill="currentColor"
      className={`bi bi-trash ${props.className ? props.className : ''}`}
      viewBox="0 0 16 16"
    >
...
export function RecycleIcon(props) {
  return (
    <svg
      ...
      height="16"
      fill="currentColor"
      className={`bi bi-recycle ${props.className ? props.className : ''}`}
      viewBox="0 0 16 16"
    >
